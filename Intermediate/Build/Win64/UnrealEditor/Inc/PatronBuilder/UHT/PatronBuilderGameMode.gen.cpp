...
struct Z_CompiledInDeferFile_FID_bomberman_PatronBuilder_Source_PatronBuilder_PatronBuilderGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APatronBuilderGameMode, APatronBuilderGameMode::StaticClass, TEXT("APatronBuilderGameMode"), &Z_Registration_Info_UClass_APatronBuilderGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APatronBuilderGameMode), 1742526873U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_bomberman_PatronBuilder_Source_PatronBuilder_PatronBuilderGameMode_h_30758955(TEXT("/Script/PatronBuilder"),
